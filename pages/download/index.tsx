...
const Download = () => {
  ...
  return (
    <Stack style={{ padding: '50px', textAlign: 'center', minHeight: "450px", alignItems: "center", justifyContent: "center" }}>
      ...
      <Stack direction="row" spacing={3} alignItems="center" justifyContent="center" marginTop={5}>
        <Button
          ...
          sx={{ boxShadow: "none", backgroundColor: "white", color: "#F74E53", border: "2px solid", borderRadius: "30px", borderColor: "#F74E53" }}
        >
          {t('download_android')}
        </Button>
        <Button
